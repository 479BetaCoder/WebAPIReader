...
<h1 id="wtrTitle">Feed Reader</h1>
	...
	<div>
		<form class="form-horizontal" action="Subscribe">
			<div class="form-group">
				<label class="control-label col-sm-2" for="txtFeedUrl">Feed
					URL : </label>
				<div class="col-sm-5">
					<input class="form-control" type="text" name="txtFeedUrl">

					<label for="lnkfeed"> <a
						href="https://www.uen.org/feeds/lists.shtml"
						title="Find feed links here" target="_blank">Need Help?</a></label>
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-2" for="txtFeedLimit">Feed
					Limit : </label>
				<div class="col-sm-5">
					<input class="form-control" type="text" name="txtFeedLimit">
				</div>
			</div>
			<div class="form-group">
	...
	<% if (session.getAttribute("rss") != null) { %>
	<div id="hdrLocation">
		<label id="lblCityValue" for="lblCityValue"> Active Subscriptions</label>
		<img id="imgSubscribe" alt="subImg" src="./Images/subscribe.jpg">
	</div>
	<div>
