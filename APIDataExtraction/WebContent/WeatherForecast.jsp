...
<div>
	<form id="frmWeather" class="form-horizontal" action="WeatherForecast" method="get">
		...
		<div class="form-group">
			...
			<div class="col-sm-5">
				...
				</select> <label id="noteLanguage">NOTE: Translation is only applied for the "sky
					status" field.</label>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<div class="col-sm-offset-2 col-sm-10">
				<button id="btnForecast" type="submit" class="btn btn-default" name="btnForecast">Get
					Forecast</button>
			</div>
		</div>
